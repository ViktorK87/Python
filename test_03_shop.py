...
input_user = driver.find_element(By.CSS_SELECTOR, (".input_error[placeholder='Username']"))
input_pswrd = driver.find_element(By.CSS_SELECTOR, (".input_error[placeholder='Password']"))
...
last_total = "$" + re.findall(r'\d+', total)[0] + "." + re.findall(r'\d+', total)[1]
